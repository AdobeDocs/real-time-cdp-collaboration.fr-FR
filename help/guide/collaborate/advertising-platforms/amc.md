...
Après avoir établi une connexion avec [!DNL Amazon Marketing Cloud] ([!DNL AMC]), les annonceurs peuvent [créer un projet](../manage-projects.md#create-project) pour collaborer avec [!DNL AMC]. Deux cas d’utilisation sont pris en charge dans un projet [!DNL AMC] : **Découverte d’audience** à l’aide de la section **[!UICONTROL Découverte]** et **Mesure** à l’aide de l’onglet **[!UICONTROL Mesure]**.
...
L’onglet **[!UICONTROL Mesure]** est disponible lorsque votre instance [!DNL AMC] contient des identifiants de campagne. Lorsque vous créez un projet, Real-Time CDP Collaboration exécute des requêtes en arrière-plan sur vos données [!DNL AMC] afin de renseigner la section [!UICONTROL Découvrir] ainsi que les listes d’événements de campagne et de conversion utilisées pour configurer les rapports de mesure.

Pour obtenir des instructions détaillées sur la création et l&#39;interprétation des rapports de mesure [!DNL AMC], consultez le guide [Créer des rapports de mesure AMC](./amc-measure.md).
