...
La boîte de dialogue **[!UICONTROL Modifier les clés de correspondance]** s’ouvre, où vous pouvez activer/désactiver les clés de correspondance que vous ne souhaitez pas utiliser. Sélectionnez **[!UICONTROL Enregistrer]** pour enregistrer vos modifications.
...
* [Audiences sourcées](/help/guide/setup/onboard-audiences.md) dans votre compte
* [Connecté](/help/guide/connect/establishing-connections.md) avec un collaborateur avec l’option de cas d’utilisation **Découverte d’audience** activée
...
| Mesure | Description |
|---------|----------|
| **[!UICONTROL Nombre d’identités]** (la vôtre) | Nombre d’identifiants uniques dans votre ou vos audience(s) sélectionnée(s). |
...
| **[!UICONTROL Clés correspondantes]** | Les clés de correspondance sélectionnées par votre collaborateur pour l’audience. |
...
![L’espace de travail Discover avec l’option Modifier l’audience mise en surbrillance.](/help/assets/collaborate/discover/change-audience.png)

La boîte de dialogue **[!UICONTROL Modifier l’audience]** s’ouvre, dans laquelle vous pouvez sélectionner une audience spécifique à comparer aux audiences de vos collaborateurs. Sélectionnez les audiences souhaitées ou effacez vos sélections pour sélectionner toutes les audiences, puis sélectionnez **[!UICONTROL Enregistrer]**.

![Boîte de dialogue Modifier l’audience dans l’espace de travail Discover.](/help/assets/collaborate/discover/change-audience-selection.png)
...
![L&#39;annonceur automobile contre les audiences de l&#39;éditeur CTV.](/help/assets/collaborate/discover/audience-index-score-example.png)
...
Après avoir exploré et découvert les audiences souhaitées, il est temps de [activer](/help/guide/collaborate/activate.md) les audiences qui doivent être utilisées dans les campagnes.
