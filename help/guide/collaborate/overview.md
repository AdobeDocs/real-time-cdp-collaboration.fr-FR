...
| Cas d’utilisation | Project section |
| --- | --- |
| Mesure de campagne | This use case grants access to the [Measure](/help/guide/collaborate/measure.md) section and all available functionality. |
| Découverte de l’audience | This use case grants access to the [Discover](/help/guide/collaborate/discover.md) section and all available functionality. |
| Activation de l’audience | This use case grants access to the [Activate](/help/guide/collaborate/activate.md) section and all available functionality. |
