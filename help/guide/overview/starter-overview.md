...
# Présentation d’Adobe Real-Time CDP Collaboration Starter

Avec Adobe Real-Time CDP Collaboration Starter, vous pouvez rejoindre un partenaire sous licence et travailler avec lui sur une collaboration en matière de données axée sur la confidentialité sans avoir à obtenir votre propre licence Collaboration.
...
En tant que client Starter invité, vous pouvez :

* Intégration et gestion des données de collaboration dans un compte Starter
...
Pour commencer à utiliser Collaboration Starter, assurez-vous que votre entreprise et votre partenaire sous licence se trouvent dans la même région. Vous devez être invité par un partenaire titulaire d’une licence Real-Time CDP Prime, Ultimate ou Collaboration.
...
* Secteur industriel
* Nom de l’administrateur (s’il est différent du nom du contact)
* Adresse e-mail du contact administrateur (si différente de l’adresse e-mail du contact)

Après avoir reçu et accepté l’invitation, votre entreprise doit vérifier et signer une commande client gratuite avec Adobe pour accéder à Collaboration Starter.
